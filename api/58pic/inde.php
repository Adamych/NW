...
<div style="box-shadow: 5px 5px 25px 0 rgba(46,61,73,.2);border-radius:15px;font-size:13px;width:950px;font-family:微软雅黑,'Helvetica Neue',Arial,sans-serif;margin:10px auto 0px;border:0px solid #eee;max-width:100%;">
    <div style="width:100%;background-color: #3174ed;background-image: linear-gradient(90deg, #3174ed 0%, #FA8BFF 35%, #3fd9fb 88%);color:#FFFFFF;border-radius:15px 15px 0 0;">
        <h2 style="font-size:15px;word-break:break-all;padding:20px 32px;margin:0;text-align:center">千图网无水印解析下载</h2>
    </div>
    <div style="margin:0px auto;width:90%">
		...
		<hr>
		# 请求地址 #<br/>
		<a style="color:#fd4b5c;text-decoration:none;">1.<?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/58pic/index.php?PicUrl=</a><br/>
		<a style="color:#fd4b5c;text-decoration:none;">2.<?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/58pic/showPic.php?img_url=</a><br/>
		# 参数 #<br/>
		<li>text //输入千图网的图片链接(解析后的图片显示链接+图片)</li>
        <li>size //千图网图片输入地址如(https://www.58pic.com/newpic/34816843.html)</li>
		<hr>
		# 返回数据 #<br/>
		...
		# 备注 #<br/>
		-=-=-=-显示解析后的图片如：
<?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/58pic/showPic.php?img_url=http://pic.qiantucdn.com/58pic/34/81/68/43g58PIC9ZK2GIjdy4Nff_PIC2018.jpg<br/>
		<hr>
		# 示例 #<br/>
		<a style="color:#fd4b5c;text-decoration:none；" target="_blank">1.<?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/58pic/index.php?PicUrl=https://www.58pic.com/newpic/34816843.html</a><p><a style="color:#fd4b5c;text-decoration:none；" target="_blank">2.<?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/58pic/showPic.php?img_url=http://pic.qiantucdn.com/58pic/34/81/68/43g58PIC9ZK2GIjdy4Nff_PIC2018.jpg</a>
		</h3>
          </div>
</div>
<script>

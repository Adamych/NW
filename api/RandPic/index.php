...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/RandPic/call.php</span></p>
        <p><strong>返回格式：</strong><span>URL/images</span></p>
        <p><strong>请求示例1：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/RandPic/call.php?.jpg</span></p>
        <p><strong>请求示例2：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/RandPic/call.php</span></p>
    </div>

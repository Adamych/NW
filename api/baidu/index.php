...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/baidu/api.php</span></p>
        <p><strong>返回格式：</strong><span>json/Unicode</span></p>
        <p><strong>输入查询方法：</strong><span>请勿输入带http://或者https://</span></p>
        <p><strong>输入格式：</strong><span>如：baidu.com</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/baidu/api.php?url=baidu.com</span></p>
    </div>
    ...
    <div class="simpleTable">
        ...
        <div class="prediv">
            <pre>{"code":"\u5DF2\u6536\u5F55","msg":"100"}</pre>
        </div>
          </div>
    <div class="simpleTable">
        <p class="linep">Unicode转码：</p>
        <a href="http://zhiyun.ppdsw.xyz/hj/ua.html">点击查看Unicode转码</a>
    </div>
</main>

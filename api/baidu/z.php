...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/baidu/jx.php</span></p>
        <p><strong>返回格式：</strong><span>json/images</span></p>
        <p><strong>输入格式：</strong><span>请勿输入http://或https://域名前骤不用输入</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/baidu/jx.php?url=baidu.com</span></p>
    </div>

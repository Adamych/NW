...
<meta name="description" content="随机壁纸api,动漫壁纸api,美女壁纸api,一言api,随机头像api,加群api,动漫头像api,手机壁纸api,电脑壁纸api,自动换壁纸api,代刷网api,新浪短网址生成,新浪网址缩短,新浪短网址还原">
<meta name="keywords" content="随机壁纸api,动漫壁纸api,美女壁纸api,一言api,随机头像api,加群api,动漫头像api,手机壁纸api,电脑壁纸api,自动换壁纸api,代刷网api,新浪短网址生成,新浪网址缩短,新浪短网址还原">
...
<div style="box-shadow: 5px 5px 25px 0 rgba(46,61,73,.2);border-radius:15px;font-size:13px;width:950px;font-family:微软雅黑,'Helvetica Neue',Arial,sans-serif;margin:10px auto 0px;border:0px solid #eee;max-width:100%;">
    ...
    <div style="margin:0px auto;width:90%">
        ...
        短网址还原:<?php echo '<?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/dwz/api.php?type=long&url=https://url.cn/569l0iB
		<hr>
		# 示例 #<br/>
		<a style="color:#fd4b5c;text-decoration:none；" target="_blank"><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/api.php?url=http://zhiyun.ppdsw.xyz</a><br>
        <a style="color:#fd4b5c;text-decoration:none；" target="_blank"><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/dwz/api.php?url=http://zhiyun.ppdsw.xyz&encode=json</a>
		</h3>
          </div>
</div>
<script>

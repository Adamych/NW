...
<div style="box-shadow: 5px 5px 25px 0 rgba(46,61,73,.2);border-radius:15px;font-size:13px;width:950px;font-family:微软雅黑,'Helvetica Neue',Arial,sans-serif;margin:10px auto 0px;border:0px solid #eee;max-width:100%;">
    <div style="width:100%;background-color: #3174ed;background-image: linear-gradient(90deg, #3174ed 0%, #FA8BFF 35%, #3fd9fb 88%);color:#FFFFFF;border-radius:15px 15px 0 0;">
        <h2 style="font-size:15px;word-break:break-all;padding:20px 32px;margin:0;text-align:center">QQ电脑在线状态 - API</h2>
    </div>
    <div style="margin:0px auto;width:90%">
		...
		<hr>
		# 请求地址 #<br/>
		<a style="color:#fd4b5c;text-decoration:none;"><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/qpc/api.php</a><br/>
		# 参数 #<br/>
		<li>qq //要查询的QQ号(必填)</li> 
		<hr>
		# 返回数据 #<br/>
		...
		<hr>
		# 示例 #<br/>
		<a style="color:#fd4b5c;text-decoration:none；" target="_blank"><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/qpc/api.php?qq=1455112844</a>
		</h3>
          </div>
</div>
<script>

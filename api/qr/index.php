...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/qr/qr.php</span></p>
        <p><strong>返回格式：</strong><span>json/images</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/qr/qr.php?url=http://zhiyun.ppdsw.xyz</span></p>
    </div>

...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/sfz/api.php</span></p>
        <p><strong>返回格式：</strong><span>json</span></p>
        <p><strong>请求示例1：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/sfz/api.php?id=30213</span></p>
            <p><strong>请求示例2：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/sfz/api.php?url=http://star.longzhu.com/30213</span></p>
    </div>

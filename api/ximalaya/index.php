...
<head>
    ...
    <title>喜马拉雅FM主播信息采集-玖云API</title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/ximalaya/api.php</span></p>
        <p><strong>返回格式：</strong><span>json</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/ximalaya/api.php?PD=1&PS=200&UD=1000667</span></p>
    </div>
        ...
        <table class="api-table" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td class="url">PS</td>
                    <td class="url">页面信息大小</td>
                    <td>返回页面大小</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td class="url">UD</td>
                    <td class="url">主播IP号</td>
                    <td>返回主播信息</td>
                </tr>
...
<footer class="copyright mt-5">
        <div class="container">© 2019玖云API开放平台</div>
    </footer>
</body>

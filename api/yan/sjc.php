...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/yan/sj.php</span></p>
        <p><strong>返回格式：</strong><span>json/GBK</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/yan/sj.php?url=13288121931</span></p>
    </div>
    ...
    <div class="simpleTable">
        ...
        <table class="api-table" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td class="url">carrier</td>
                    <td class="url">string</td>
                    <td>返回地区类型信息</td>
                </tr>
<tr>
                    <td>&nbsp;</td>
                    <td class="url">telString</td>
                    <td class="url">string</td>
                    <td>返回的查询的手机号</td>
                </tr>             
            </tbody>
    ...
    <div class="simpleTable">
        ...
        <div class="prediv">
            <pre>{"mts:'1305822', province:'广东', catName:'中国联通', telString:'13058223212', areaVid:'30517', ispVid:'137815084', carrier:'广东联通'"}</pre>
        </div>
    </div>
</main>
